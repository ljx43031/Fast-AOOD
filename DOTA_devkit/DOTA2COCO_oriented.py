    ...
    with open(destfile, 'w') as f_out:
        ...
        for file in filenames:
            ...
            for obj in objects:
                ...
                cnt = np.array([obj['poly'][0:2],obj['poly'][2:4],obj['poly'][4:6],obj['poly'][6:8]])
                ...
                if height >= width:
                    ...
                    width = temp
                    Plus90 = 1
                xmin = rect_min[0][0] - width / 2
                ymin = rect_min[0][1] - height / 2
                single_obj['bbox'] = xmin, ymin, width, height
                single_obj['rotate'] = rect_min[2] + Plus90 * 90
...
if __name__ == '__main__':
    DOTA2COCO(r'D:\program\YOLOX\DOTA_devkit\example', r'D:\program\YOLOX\DOTA_devkit\example\DOTA_test.json')
